...
namespace TeraJet
{
    public class NotificationHandler
    {
        ...
        static string _Channel_Id = "notify_daily_reminder";
        ...
        public static void NotificationInitialize()
        {
            ...
            if (notification_intent_data != null && NotificationHandler.Handled_Ids.Contains(notification_intent_data.Id.ToString()) == false)
            {
                NotificationHandler.Handled_Ids.Add(notification_intent_data.Id.ToString());
