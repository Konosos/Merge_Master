...
namespace MergeHero
{
    ...
    public class MatchManager : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject mergeParticel;
        ...
        private void SpawnMonster(int playerPower)
        {
            ...
            {
                GameObject obj = CreateChar(ChessCreater.Instance.PowerToName(CharacterType.Monster, CombatType.Melee, meleePowerLists[i]), meleeX, meleeY);
                obj.layer = 9;
                meleeX--;
                if(meleeX < 0)
                {
            ...
            {
                GameObject obj = CreateChar(ChessCreater.Instance.PowerToName(CharacterType.Monster, CombatType.Range, rangePowerLists[i]), rangeX, rangeY);
                obj.layer = 9;
                rangeX++;
                if (rangeX > 4)
                {
